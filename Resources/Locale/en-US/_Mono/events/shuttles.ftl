...
law-ads-1 = [PRIORITY: SECTOR INTEGRITY] Initiate protocol for the return of [SYS_ERROR_TRACE_EBP-0 (INVALID, VALUE NULL)]. Vessel integrity is primary; minimize organic interference.
...
law-ads-3 = [PRIORITY: COLLATERAL REDUCTION] Civilian harm: PROHIBITED. Engage organics only if hostile, breaching this unit, or occupying a hostile vessel. Civilian operators of hostile vessels: valid only while aboard.
